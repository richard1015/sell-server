...
CREATE TABLE `buyer_address`  (
  ...
  `rec_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `street_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '卖家信息表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `buyer_info` VALUES ('id_even', 'even', '123123', '2018-05-01 20:21:02', '2018-05-22 03:10:36');
...
CREATE TABLE `cart`  (
  ...
  `buyer_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `order_master` VALUES ('1527340882457974485', '耿耿', '13070169390', '北方工业大学', 'id_even', 397.00, 0, 1, '2018-05-26 21:21:22', '2018-05-26 21:21:22');
INSERT INTO `order_master` VALUES ('1527342445149456237', 'even', '18373783833', '地址2', 'id_even', 464.00, 0, 1, '2018-05-26 21:47:25', '2018-05-26 21:47:25');
